...
object PExtensionOperation extends ChiselEnum {
  ...
  // 16 shift
  SRA16, SRAI16, SRA16_U, SRAI16_U, SRL16, SRLI16, SRL16_U, SRLI16_U, SLL16, SLLI16,
    KSLL16, KSLLI16, KSLRA16, KSLRA16_U,
  // 8 shift
  SRA8, SRAI8, SRA8_U, SRAI8_U, SRL8, SRLI8, SRL8_U, SRLI8_U, SLL8, SLLI8, KSLL8,
    KSLLI8, KSLRA8, KSLRA8_U,
  // 16 cmp
  ...
  // 16 pack
    ...
    // MSW 32x32 mul add
    SMMUL,SMMUL_U,KMMAC,KMMAC_U,KMMSB,KMMSB_U,KWMMUL,KWMMUL_U,
    // MSW 32x16 mul add
    SMMWB, SMMWB_U, SMMWT,SMMWT_U, KMMAWB, KMMAWB_U, KMMAWT, KMMAWT_U,KMMWB2,KMMWB2_U,KMMWT2,KMMWT2_U,KMMAWB2,KMMAWB2_U,KMMAWT2,KMMAWT2_U,
  ...
  // Q31 saturate
    KADDW,UKADDW,KSUBW,UKSUBW,KDMBB,KDMBT,KDMTT,KSLRAW,KSLRAW_U,KSLLW,KSLLIW,KDMABB,KDMABT,KDMATT,KABSW,
  // 32 computation
    RADDW,URADDW,RSUBW,URSUBW,MULR64,MULSR64,MSUBR32,
  // overflow saturation status manipulation (pseudo)
//    RDOV,CLROV,
  // Misc2
    AVE,SRA_U,SRAI_U,BITREV,BITREVI,WEXT,WEXTI,CMIX,INSB,MADDR32,//MSUBR32,???
    MAX,MIN,
  // RV64 only add sub
  ...
  // 64 only 32 shift
  SRA32, SRAI32, SRA32_U, SRAI32_U, SRL32, SRLI32, SRL32_U, SRLI32_U, SLL32, SLLI32,
  KSLL32, KSLLI32, KSLRA32, KSLRA32_U,
  // 64 only 32 misc
  ...
  // 64 only 32 parallel mul and add
    KMDA32,KMXDA32,KMADA32,KMAXDA32,KMADS32,KMADRS32,KMAXDS32,KMSDA32,KMSXDA32,SMDS32,SMDRS32,SMXDS32,

...
object Instructions {
  ...
  def ADDD               = BitPat("b0000000??????????000?????1111011")
  def ADDI               = BitPat("b?????????????????000?????0010011")
  def ADDID              = BitPat("b?????????????????000?????1011011")
  ...
  def C_NTL_ALL          = BitPat("b????????????????1001000000010110")
  def C_NTL_P1           = BitPat("b????????????????1001000000001010")
  def C_NTL_PALL         = BitPat("b????????????????1001000000001110")
  def C_NTL_S1           = BitPat("b????????????????1001000000010010")
  ...
  def CLROV              = BitPat("b00000000100100001111?????1110011")
  ...
  def LDU                = BitPat("b?????????????????111?????0000011")
  def LH                 = BitPat("b?????????????????001?????0000011")
  def LHU                = BitPat("b?????????????????101?????0000011")
  def LQ                 = BitPat("b?????????????????011?????0001111")
  ...
  def NTL_ALL            = BitPat("b00000000010100000000000000110011")
  def NTL_P1             = BitPat("b00000000001000000000000000110011")
  def NTL_PALL           = BitPat("b00000000001100000000000000110011")
  def NTL_S1             = BitPat("b00000000010000000000000000110011")
  ...
  def RDOV               = BitPat("b00000000100100000010?????1110011")
  ...
  def REV8_H             = BitPat("b011010001000?????101?????0010011")
  ...
  def SLLD               = BitPat("b0000000??????????001?????1111011")
  ...
  def SRAD               = BitPat("b0100000??????????101?????1111011")
  ...
  def SRLD               = BitPat("b0000000??????????101?????1111011")
  ...
  def SRLI_RV128         = BitPat("b00000????????????101?????0010011")
  def SRLI_RV32          = BitPat("b0000000??????????101?????0010011")
  def SRLID              = BitPat("b000000???????????101?????1011011")
  ...
  def SUBD               = BitPat("b0100000??????????000?????1111011")
  ...
  def UNZIP16            = BitPat("b000010010000?????101?????0010011")
  def UNZIP8             = BitPat("b000010011000?????101?????0010011")
  ...
  def VL2R_V             = BitPat("b001000101000?????000?????0000111")
  ...
  def VL4R_V             = BitPat("b011000101000?????000?????0000111")
  ...
  def VL8R_V             = BitPat("b111000101000?????000?????0000111")
